...
export default function Portfolio() { return <>
  ...
  <section className="cta page-cta"><p className="s-tag">Discuss Your Collection</p><h2 className="s-title">Start with the right <em>development route.</em></h2><p className="cta-sub">Share your category, style count, quantity and target date. We will recommend design only, sampling or a reviewed production scope.</p><div className="cta-btns"><a href="/contact#get-in-touch" className="btn btn-gold">Start Your Project →</a><a href="/services" className="btn btn-outline-ivory">View Services</a></div></section>
  <Footer />
</>; }
